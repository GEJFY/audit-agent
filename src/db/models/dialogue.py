...
class DialogueMessage(BaseModel, TimestampMixin):
    ...
    structured_content: Mapped[dict | None] = mapped_column(JSONB, default=dict)
    ...
    # 添付・証跡
    attachments: Mapped[list | None] = mapped_column(JSONB, default=list)  # [{file_name, s3_path, file_hash}]
